...
<head>
	...
	{{--<script type="text/javascript" src="{{asset("/assets/inc/js/bootstrap.min.js")}}"></script>--}}
	...
	<link rel='stylesheet' id='all_css-css' href='{{asset('/assets/css/all.min.css?ver=4.7.5')}}' type='text/css' media='all' />
	<link rel='stylesheet' id='boostrap_css-css' href='{{asset("/assets/css/bootstrap.min.css?ver=4.7.5")}}' type='text/css' media='all' />
	<link rel='stylesheet' id='style_css-css' href='{{asset("/assets/css/style.css')}}' type='text/css'/>
	<link rel='stylesheet' id='main_css-css' href='{{asset("/assets/css/main.css?ver=4.7.5")}}' type='text/css' media='all' />
	<link rel='stylesheet' id='awesome_css-css' href='{{asset("/assets/icons/css/font-awesome.min.css?ver=4.7.5")}}' type='text/css' media='all' />
	<script type='text/javascript' src='{{asset("/assets/inc/js/assets1.min.js?ver=4.7.5")}}'></script>
</head>
						...
						<div class="pas-list">
							...
							<ul class="list-episodes ps-container active">
								...
								<li onclick="load_episode_iframe" class="episode-item" data-drive="https://putload.tv/embed-iz7w3m45beiz.html">
									<a>
										<i class="icon-play_arrow"></i>{{ $channel->channelname }}
									</a>
								</li>
								@endforeach
