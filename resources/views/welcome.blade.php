                    ...
                    <div class="pa-main">
                        <div>
                            <video id="iframe-embed" width="100%" height="500"
                                   ...
                                   preload="auto"
                                   data-setup="">
                                <source src="{{ $ulchannels }}" type="application/x-mpegURL">
                            </video>
                        </div>
                            ...
                            <ul class="list-episodes ps-container active">
                                ...
                                @foreach($channels as $channel)
                                    <li class="episode-item">
                                        @if($currentSection)
                                            <a href="/{{$currentSection}}/play/{{$channel->id}}"><i class="icon-play_arrow"></i>{{$channel->channelname}}</a>
                                        @endif

                                            @if(!$currentSection)
                                                <a href="/play/{{$channel->id}}"><i class="icon-play_arrow"></i>{{$channel->channelname}}</a>
                                            @endif
