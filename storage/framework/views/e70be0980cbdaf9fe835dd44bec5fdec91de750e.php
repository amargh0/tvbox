    ...
    <div class="row row-offcanvas row-offcanvas-left">
        <div class="col-xs-6 col-sm-3 sidebar-offcanvas" role="navigation">
            <ul class="list-group panel">
                ...
                <li class="list-group-item"><a href="<?php echo e(asset('channel/list')); ?>"><i class="glyphicon glyphicon-th-list"></i>Channel List </a></li>
                <li class="list-group-item"><a href="<?php echo e(asset('channel/create')); ?>"><i class="glyphicon glyphicon-th-large"></i>Tables and List </a></li>
            </ul>
        </div>
